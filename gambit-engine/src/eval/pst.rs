...
static PAWN_MIDGAME_TABLE: SquareMap<i32> = SquareMap::from_array([
...
static PAWN_ENDGAME_TABLE: SquareMap<i32> = SquareMap::from_array([
...
static KNIGHT_MIDGAME_TABLE: SquareMap<i32> = SquareMap::from_array([
...
static KNIGHT_ENDGAME_TABLE: SquareMap<i32> = SquareMap::from_array([
...
static BISHOP_MIDGAME_TABLE: SquareMap<i32> = SquareMap::from_array([
...
static BISHOP_ENDGAME_TABLE: SquareMap<i32> = SquareMap::from_array([
...
static ROOK_MIDGAME_TABLE: SquareMap<i32> = SquareMap::from_array([
...
static ROOK_ENDGAME_TABLE: SquareMap<i32> = SquareMap::from_array([
...
static QUEEN_MIDGAME_TABLE: SquareMap<i32> = SquareMap::from_array([
...
static QUEEN_ENDGAME_TABLE: SquareMap<i32> = SquareMap::from_array([
...
static KING_MIDGAME_TABLE: SquareMap<i32> = SquareMap::from_array([
...
static KING_ENDGAME_TABLE: SquareMap<i32> = SquareMap::from_array([
...
pub fn pst(piece_type: PieceType, square: Square, colour: Colour, endgame: bool) -> i32 {
    let index = if colour == Colour::White {
        square
    } else {
        square.flip_rank()
    };

    let table = match (piece_type, endgame) {
        (PieceType::Pawn, false) => PAWN_MIDGAME_TABLE,
        (PieceType::Pawn, true) => PAWN_ENDGAME_TABLE,
        (PieceType::Knight, false) => KNIGHT_MIDGAME_TABLE,
        (PieceType::Knight, true) => KNIGHT_ENDGAME_TABLE,
        (PieceType::Bishop, false) => BISHOP_MIDGAME_TABLE,
        (PieceType::Bishop, true) => BISHOP_ENDGAME_TABLE,
        (PieceType::Rook, false) => ROOK_MIDGAME_TABLE,
        (PieceType::Rook, true) => ROOK_ENDGAME_TABLE,
        (PieceType::Queen, false) => QUEEN_MIDGAME_TABLE,
        (PieceType::Queen, true) => QUEEN_ENDGAME_TABLE,
        (PieceType::King, false) => KING_MIDGAME_TABLE,
        (PieceType::King, true) => KING_ENDGAME_TABLE,
    };
